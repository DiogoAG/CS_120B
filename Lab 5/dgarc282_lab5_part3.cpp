...
enum Code{UP, UP, DOWN, DOWN, LEFT, LEFT, RIGHT, RIGHT, CLICK, CLICK} code;
enum Signal{UP, DOWN, LEFT, RIGHT, CLICK} signal;

const char sound_pattern_size = 5;
const double sound_pattern[sound_pattern_size] = {329.63,261.63, 293.66, 440, 493.88}; // C4, D4
